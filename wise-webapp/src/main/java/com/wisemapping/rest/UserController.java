...
public class UserController extends BaseController {
	...
	@RequestMapping(method = RequestMethod.POST, value = "/users/googleCallback", produces = { "application/json" })
	...
	@RequestMapping(method = RequestMethod.PUT, value = "/users/confirmAccountSync", produces = { "application/json" })
	@ResponseStatus(value = HttpStatus.OK)
